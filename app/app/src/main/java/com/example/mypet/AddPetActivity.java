                 ...
                 petService.register(pet,token).enqueue(new Callback<Pet>() {
                     ...
                     public void onResponse(Call<Pet> call, Response<Pet> response) {
                         if(response.isSuccessful()){
                             Toast.makeText(AddPetActivity.this, "Welcome to MyPet", Toast.LENGTH_SHORT).show();
                             Intent itPetLogin = new Intent(AddPetActivity.this, PetLoginScreen.class);
                             startActivity(itPetLogin);
                             finish();
                         }else{
                             Toast.makeText(AddPetActivity.this, "Error! Try again later!", Toast.LENGTH_SHORT).show();
                         }
                     }

                     @Override
                     public void onFailure(Call<Pet> call, Throwable t) {
                         Toast.makeText(AddPetActivity.this, "erro", Toast.LENGTH_SHORT).show();
                     }
                 });
            }
        });
