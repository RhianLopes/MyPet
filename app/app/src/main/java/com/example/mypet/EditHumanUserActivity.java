                ...
                userService.update(user,token).enqueue(new Callback<User>() {
                    ...
                    public void onResponse(Call<User> call, Response<User> response) {
                        if(response.isSuccessful()){
                            ...
                            Intent itPet = new Intent(EditHumanUserActivity.this, PetLoginScreen.class);
                            startActivity(itPet);
                            finish();
                        }else{
                            Toast.makeText(EditHumanUserActivity.this, "Error! Try again later!", Toast.LENGTH_SHORT).show();
                        }
                    }

                    @Override
                    public void onFailure(Call<User> call, Throwable t) {
                        Toast.makeText(EditHumanUserActivity.this, "erro", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
